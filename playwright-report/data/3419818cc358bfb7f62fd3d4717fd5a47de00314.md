...
Call log:
  - waiting for locator('tr:has-text("Kegiatan Pengujian Otomatis 1749436835610")').first().locator('button.bg-red-500[title="Hapus Kegiatan"]')
...
- combobox:
  ...
  - option "Selesai"
- textbox "Cari berdasarkan nama kegiatan...": Kegiatan Pengujian Otomatis 1749436835610
- img
- list:
  - listitem:
    - button "Semua"
