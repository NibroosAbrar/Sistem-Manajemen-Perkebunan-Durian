...
<head>
    ...
    <title>Reset Kata Sandi - Symadu</title>
...
<body class="flex items-center justify-center min-h-screen p-4">
    ...
    <div class="w-full max-w-md card-login p-8">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold brand-title">Reset Kata Sandi</h1>
        ...
        <form method="POST" action="{{ route('password.update') }}" class="space-y-5">
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-gray-700 mb-1">Kata Sandi Baru<span class="text-red-500">*</span></label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
